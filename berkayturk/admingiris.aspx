<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admingiris.aspx.cs" Inherits="berkayturk.admingiris" %>
...
<body style="background-image:url('bs/css/rsm/admn.jpg');background-repeat:no-repeat; background-attachment:fixed;background-position:center;margin-top:0px;padding-top:0px;" >
    ...
    <div class="form-group">
        <div class="col-md-12 text-center">
            <a href="https://myaccount.google.com/">Parolanızımı unuttunuz ?</a>
            <input type="checkbox" name="prl" /> Parolayı Hatırla 
