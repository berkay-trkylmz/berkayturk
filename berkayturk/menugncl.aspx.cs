            ...
            else
            {
                if (IsPostBack == false)
                {
                    ...
                    else
                    {
                        ...
                        bag.Open();
                        OleDbCommand komut = new OleDbCommand("select * from isler where menuid=" + gelenid, bag);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    OleDbCommand komut = new OleDbCommand("update isler set menuad=@menuad,menufoto=@menufoto,menukonu=@menukonu,menukısa=@menukısa where menuid=" + gelenid, bag);
