<%@ Page Title="" Language="C#" MasterPageFile="~/Taslak.Master" AutoEventWireup="true" CodeBehind="iletisim.aspx.cs" Inherits="berkayturk.iletisim" %>
  ...
  <div>
       <form runat="server" class="form-horizontal" style="width:80%;margin-top:50px;text-align:center;">
        ...
        <div class="col-md-4 text-center" style="text-align: center;padding-left:25px;">
          ...
          <p>
            <b>Email:</b> berkay_trkylmz@hotmail.com <br />
            <b>Email:</b> muhasebe@berkayturk.com
          </p>
        </div>
  </div>
</asp:Content>
